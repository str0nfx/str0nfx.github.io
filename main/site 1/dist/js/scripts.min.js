...
$(function(){jQuery(document).ready(function(){jQuery("ul.sf-menu").superfish({delay:400})}),jQuery(document).ready(function(){jQuery(".header-slider").owlCarousel({items:1,loop:!0,autoplay:!0,autoplayTimeout:4e3,smartSpeed:1500,dots:!0})}),jQuery(document).ready(function(){jQuery(".portfolio-slider").owlCarousel({items:3,loop:!0,smartSpeed:1500})}),$(document).ready(function(){var o=$(".portfolio-slider");$(".next").on("click",function(){o.trigger("next.owl.carousel",[500])}),$(".prev").on("click",function(){o.trigger("prev.owl.carousel",[500])})}),jQuery(document).ready(function(){jQuery(".quote-slider").owlCarousel({items:1,loop:!0,autoplay:!0,autoplayTimeout:3e3,smartSpeed:1500,dots:!0})}),$(function(){$(window).scroll(function(){0!=$(this).scrollTop()?$(".footer-button").fadeIn():$(".footer-button").fadeOut()}),$(".footer-button").click(function(){$("body,html").animate({scrollTop:0},800)})})});